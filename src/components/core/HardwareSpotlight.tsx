        ...
        <section id="how-it-works" ref={sectionRef} className="bg-brand-black text-brand-white border-b border-white/10">
            <div className="grid grid-cols-1 lg:grid-cols-4">
                ...
                {products.map((product) => (
                    <div key={product.id} className="product-cell polk-hover-line group relative aspect-[4/5] border-r border-white/5 last:border-r-0 lg:[&:nth-child(n+1)]:border-b-0 border-b lg:border-b-0 cursor-pointer overflow-hidden transition-colors duration-500 hover:bg-white/5">
